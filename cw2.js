$(function() {
    // --- Data Arrays ---
    const menuData = [
        { category: 'Deals', name: 'Peri Peri Strip Meal (5 Strips)', description: 'Comes with fries and drink. Choice of sauces.', price: '10.99', image: 'image/img1.webp' },
        { category: 'Deals', name: 'Peri Peri Chicken Chunks on Rice Meal', description: 'With regular drink. Choice of sauces.', price: '10.99', image: 'image/img2.webp' },
        { category: 'Deals', name: 'Peri Peri Loaded Fries', description: 'Fries topped with chicken chunks, cheese & garlic sauce.', price: '11.99', image: 'image/img3.webp' },
        { category: 'Platters', name: 'Mega Mix Platter', description: '2 whole chicken, 2 large fries, 10 wings, 10 strips, 2 side salad, 4 pitta bread, 1.5L drink, 8 dips.', price: '49.99', image: 'image/img4.jpeg' },
        { category: 'Platters', name: 'Mix Platter', description: 'Whole chicken, large fries, 5 wings, 5 strips, side salad, 4 pitta bread, 1.5ltr drink, 6 dips.', price: '34.99', image: 'image/img5.webp' },
        { category: 'Platters', name: 'Single Platter', description: 'Whole chicken, 2 pitta bread, large fries, side salad, 1.5L drink, 4 dips.', price: '23.99', image: 'image/img1.webp' },
